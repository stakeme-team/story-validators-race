#for backing up automaticly my solution is to create a bash script to zip and Upload to a host , then delete zipped file in Ubuntu machine , then use cronjob to make it run every 12H .
